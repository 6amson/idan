                ...
                <div className="priDiv">
                    ...
                    <div className="firstDiv">
                        ...
                        <div className="videoDiv">
                            ...
                            <video className="video3" src="https://res.cloudinary.com/dis6jfj29/video/upload/ac_aac,br_1814k,vc_h264/v1684160234/burna_iddrr9.mp4" type="video/mp4" ref={vid3} loop="loop" autoplay="autoplay" preload="auto" playsinline muted="muted"></video>
                        </div>
                    </div>
